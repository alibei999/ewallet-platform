...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[240px] bg-[#0a0a0a] border-r border-[#222222] flex flex-col py-6 px-3 z-20 overflow-y-auto">
      <div className="px-3 mb-8">
        <h1 className="text-xl font-bold text-white">eWallet</h1>
        <p className="text-xs text-[#9ca3af] mt-0.5">Payment Platform</p>
      </div>
